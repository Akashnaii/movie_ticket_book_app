                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(context, CupertinoPageRoute(builder: (context) =>
                                      DescriptionPage(snapshot: snapshots.data!.docs[index])));
                                },
                                child: Image.network(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.push(context, CupertinoPageRoute(builder: (context) => DescriptionPage2(snapshot: snapshots.data!.docs[index])));
                                },
                                child: Image.network(
                                  snapshots.data!.docs[index]['image_url'],
                                  width: 100,
